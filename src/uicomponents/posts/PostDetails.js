...
{/*          
       ...
       min="09:00" max="18:00" defaultValue={posts.deptime} />
         </div>
         <div className="input-field">
...
<select id="age" defaultValue="20-30">
  ...
  <option value="60-70">60-70</option>
      ...
      <div className="input-field">
      {(posts.authorId==user.uid)?<input type="submit" value="Submit" className="btn yellow darken-3 black-text submit buttons" />:<input disabled type="submit" value="Submit" className="btn yellow darken-3 black-text buttons" />
  }
</div>
</form>
